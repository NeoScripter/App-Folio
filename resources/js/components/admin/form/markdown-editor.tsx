...
export default function MarkdownEditor({
    ...
    const editor = useEditor({
        ...
        editorProps: {
            attributes: {
                class: 'prose prose-md leading-3! [&>p>strong,h2,h3,h4]:text-foreground! [&>blockquote,a]:text-foreground! min-h-40 max-w-full outline-none transition-[color,box-shadow] text-foreground! bg-background selection:bg-foreground selection:text-background placeholder:text-gray-500 disabled:opacity-50',
            },
        },
        content: value,
