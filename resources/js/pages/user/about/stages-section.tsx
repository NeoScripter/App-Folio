...
import { stages, StageType } from '@/lib/data/stages';
...
const StagesInfo = () => {
    ...
    return (
        <div class="mb-18 sm:mb-20.5 md:mx-auto md:max-w-155 xl:mx-0 xl:mb-0 xl:max-w-123.5 2xl:max-w-187">
            ...
            <p class="mb-8 text-center text-balance sm:mb-10 sm:text-lg lg:mb-12 xl:text-base xl:text-left 2xl:text-2xl">
            ...
            <Button
                class="text-foreground hover:ring-muted-foreground/40 xl:text-lg 2xl:text-2xl focus-visible:ring-muted-foreground/40 border-muted-none mx-auto flex hover:bg-zinc-700/20 xl:mx-0"
...
const Stages = () => {
    ...
    return (
        <ul class="grid w-fit mx-auto xl:mx-0 justify-items-center gap-8 md:grid-cols-2 md:gap-x-10 xl:gap-x-6 xl:gap-y-0 md:gap-y-2 2xl:max-w-198 2xl:mx-auto">
...
const Stage: FC<{
    ...
    return (
        <li
            ...
            class={cn(
                'bg-user-background max-w-110 rounded-xl p-8 border-accent-foreground/15  border transition-[shadow,scale]',
                {
        ...
        >
            <div
                class={cn(
                    ...
                    active ? 'bg-slide-marker text-footer-text' : 'bg-gray-300/40',
                )}
            >
                <stage.icon class="size-8" />
            </div>
            <h4 class="mb-3 text-xl font-bold 2xl:text-2xl">{`${order}. ${stage[`title${lang}`]}`}</h4>
            <p class="text-sm xl:text-sm sm:text-base 2xl:text-base">{stage[`description${lang}`]}</p>
        </li>
    );
};
