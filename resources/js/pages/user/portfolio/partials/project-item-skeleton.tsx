...
const ProjectItemSkeleton: FC<NodeProps> = ({ className }) => {
    return (
        <li
            className={cn(
            ...
            <div class="lg:flex lg:basis-2/5 lg:flex-col lg:items-start lg:justify-between 2xl:basis-1/2">
                ...
                <div>
                    <p class="skeleton mb-12 animate-pulse rounded-sm lg:mb-7 xl:mb-13.5 xl:text-xl">
                        ...
                        Aliquam facere vel voluptas rerum et?
                        Lorem ipsum dolor, sit amet consectetur adipisicing
                        elit. Perferendis dolores error expedita odio vitae.
                        Aliquam facere vel voluptas rerum et?
                    </p>
...
const ProjectInfo: FC<{ className?: string }> = ({ className }) => {
    return (
        <div className={cn('mt-7 mb-17.5 md:mt-0 md:mb-0', className)}>
            <span class="mb-4 block uppercase skeleton w-fit animate-pulse rounded-sm">Lorem Lorem</span>
            <h2 class="mb-6 text-3xl font-semibold skeleton w-fit animate-pulse rounded-sm hyphens-auto md:mb-5 xl:text-4xl">
                lorem ipsum
            </h2>
            <ul class="flex flex-wrap gap-x-3 gap-y-3">
                {range(1, 5).map((stack) => (
                    <li
                        class="flex items-center justify-center skeleton w-fit animate-pulse rounded-sm px-3 py-1"
                        key={stack}
                    >
                        lorem
                    </li>
